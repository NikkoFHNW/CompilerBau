...
public interface ConcTree {
	...
	public class RecordDeclaration extends Declaration {
		...
		public RecordDeclaration(TokenTupel ident, RecordFieldList recordStorageList){
			this.ident = ident;
	...
	public class Program {
		...
		public Program(TokenTupel ident, ProgramParameterList programParameterList, OptionalGlobalDeclarations optionalGlobalDeclarations, BlockCmd blockCmd) {
			this.ident = ident;
	...
	public class FunctionDeclaration extends Declaration {
		...
		public FunctionDeclaration(TokenTupel ident, ParameterList parameterList, StorageDeclaration storageDeclaration, OptionalGlobalImports optionalGlobalImports, OptionalLocalStorageDeclarations optionalLocalStorageDeclarations, BlockCmd blockCmd) {
			this.ident = ident;
	...
	public class ProcedureDeclaration extends Declaration {
		...
		public ProcedureDeclaration(TokenTupel ident, ParameterList parameterList, OptionalGlobalImports optionalGlobalImports, OptionalLocalStorageDeclarations optionalLocalStorageDeclarations, BlockCmd blockCmd) {
			this.ident = ident;
			this.parameterList = parameterList;
			this.optionalGlobalImports = optionalGlobalImports;
			this.optionalLocalStorageDeclarations = optionalLocalStorageDeclarations;
	...
	public class TypedIdent {
		...
		public TypedIdent(TokenTupel ident, TypeDeclaration typeDeclaration){
			this.ident = ident;
	...
	public class TypeDeclarationType extends TypeDeclaration {
		...
		private final TokenTupel type;
		
		public TypeDeclarationType(TokenTupel type){
			this.type = type;
		}
		...
		public AbsTree.TypedIdentType toAbstract(TokenTupel ident) {
	...
	public class TypeDeclarationIdent extends TypeDeclaration {
		...
		public TypeDeclarationIdent(TokenTupel ident){
			this.ident = ident;
		}
		public String toString(String indent) {
			return indent
		...
		public AbsTree.TypedIdentIdent toAbstract(TokenTupel firstIdent) {
	...
	public class RepeatingOptionalIdents {
		...
		public RepeatingOptionalIdents(TokenTupel ident, Idents idents) {
			this.ident = ident;
			this.idents = idents;
		}
	...
	public class OptionalChangeMode {
		...
		public OptionalChangeMode(TokenTupel changeMode) {
	...
	public class OptionalChangeModeEpsilon extends OptionalChangeMode {
		...
		public TokenTupel toAbstract() {
			return new TokenTupel(Terminal.CHANGEMODE,Mode.CONST);
		}
	}
	...
	public class OptionalFlowMode {
		...
		public OptionalFlowMode(TokenTupel flowMode) {
		...
		public TokenTupel toAbstract() { return flowMode; }
	}
	...
	public class OptionalFlowModeEpsilon extends OptionalFlowMode {
		...
		public TokenTupel toAbstract() { return new TokenTupel(Terminal.FLOWMODE,Mode.IN); }
	}
	
	public class OptionalMechMode {
		private final TokenTupel mechMode;

		public OptionalMechMode(TokenTupel mechMode) {
		...
		public TokenTupel toAbstract() { return mechMode; }
	}
	...
	public class OptionalMechModeEpsilon extends OptionalMechMode {
		...
		public TokenTupel toAbstract() { return new TokenTupel(Terminal.MECHMODE,Mode.COPY); }
	}
	...
	public class CmdCall extends Cmd {
		...
		public CmdCall(TokenTupel ident, ExpressionList expressionList, OptionalGlobalInits optionalGlobalInits) {
			this.ident = ident;
	...
	public class Idents {
		...
		public Idents(TokenTupel ident, RepeatingOptionalIdents repeatingOptionalIdents) {
			this.ident = ident;
	...
	public class RepBOOLOPRterm1 {
		private final TokenTupel boolOpr;
		private final Term1 term1;
		private final RepBOOLOPRterm1 repBOOLOPRterm1;

		public RepBOOLOPRterm1(TokenTupel boolOpr, Term1 term1, RepBOOLOPRterm1 repBOOLPORterm1) {
	...
	public class RepRELOPRterm2 {
		private final TokenTupel relOpr;
		private final Term2 term2;
		private final RepRELOPRterm2 repADDOPRTerm2;

		public RepRELOPRterm2(TokenTupel relOpr, Term2 term2, RepRELOPRterm2 repADDOPRTerm2) {
			this.relOpr = relOpr;
			this.term2 = term2;
	...
	public class Term3 {
		...
		public Term3(Factor factor, RepMULTOPRfactor repMULTOPRfactor) {
			this.factor = factor;
		...
		public String toString(String indent) {
			return indent
					...
					+ repMultOprFactor.toString(indent + '\t')
					+ indent
					+ "</Term3>\n";
		}
		
		public AbsTree.Expression toAbstract() {
			return repMultOprFactor.toAbstract(factor.toAbstract());
		}
	}
	
	public class RepADDOPRterm3 {
		private final TokenTupel addOpr;
		private final Term3 term3;
		private final RepADDOPRterm3 repADDOPRTerm3;

		public RepADDOPRterm3(TokenTupel addOpr, Term3 term3, RepADDOPRterm3 repTerm3) {
			this.addOpr = addOpr;
			this.term3 = term3;
	...
	public class RepMULTOPRterm4 {
		private final TokenTupel multOpr;
		private final Term4 term4;
		private final RepMULTOPRterm4 repMULTOPRterm4;

		public RepMULTOPRterm4(TokenTupel multOpr, Term4 term4, RepMULTOPRterm4 repMULTOPRterm4) {
	...
	public class RepDOTOPRfactor {
		private final TokenTupel dotOpr;
		private final Factor factor;
		private final RepDOTOPRfactor repDOTOPRfactor;
		public RepDOTOPRfactor(TokenTupel dotOpr, Factor factor, RepDOTOPRfactor repDOTOPRfactor) {
			this.dotOpr = dotOpr;
			this.factor = factor;
	...
	public class RepMULTOPRfactor {
		private final TokenTupel multOpr;
		private final Factor factor;
		private final RepMULTOPRfactor repMultOprFactor;
		public RepMULTOPRfactor(TokenTupel multOpr, Factor factor, RepMULTOPRfactor repMultOprFactor) {
		...
		public AbsTree.Expression toAbstract(AbsTree.Expression expression){
			return repMultOprFactor.toAbstract(new AbsTree.ExprDyadic(multOpr, factor.toAbstract(), expression));
		}
	}
	
	public class RepMULTOPRfactorEpsilon  extends RepMULTOPRfactor{

		public RepMULTOPRfactorEpsilon() {
			super(null,null,null);
		}
		public String toString(String indent){
			return indent + "<RepMULTOPRfactorEpsilon />\n";
		}
		public AbsTree.Expression toAbstract(AbsTree.Expression expression){
			return expression;
		}
	...
	public class FactorLiteral extends Factor {
		private final TokenTupel literal;
	...
	public class FactorIdent extends Factor {
		...
		public FactorIdent(TokenTupel ident, OptionalIdent optionalIdent) {
			this.ident = ident;
	...
	public abstract class OptionalIdent {
		public abstract String toString(String indent);
		public abstract AbsTree.Expression toAbstract(TokenTupel ident);
	}
	...
	public class OptionalIdentInit extends OptionalIdent {
		...
		public AbsTree.ExprStore toAbstract(TokenTupel ident) {
	...
	public class OptionalIdentExpressionList extends OptionalIdent {
		...
		public AbsTree.ExprFunCall toAbstract(TokenTupel ident) {
	...
	public class MonadicOperator {
		private final TokenTupel operator;

		public MonadicOperator(TokenTupel operator) {
	...
	public class GlobalImport {
		...
		public GlobalImport(OptionalFlowMode optionalFlowMode, OptionalChangeMode optionalChangeMode, TokenTupel ident){
			this.optionalFlowMode = optionalFlowMode;
			this.optionalChangeMode = optionalChangeMode;
			this.ident = ident;
		}
