...
public class RecordExpr implements IAbs.IExpr{
	...
	public TokenTupel check() throws ContextError {
    	TokenTupel res=null;
    	Store s1 = Compiler.getScope().getStoreTable().getStore(ident1.getStringVal());

    	if(s1.getType()!=null)
    	    throw new ContextError(ident1.toString() + " is not of a Rectype.",ident1.getLineNr());

    	if(s1.getRecType()==null)
